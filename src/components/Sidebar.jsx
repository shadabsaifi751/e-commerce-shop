      ...
      <AnimatePresence>
        {isNavSidebarOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 h-screen w-full bg-white text-black p-4 shadow-lg z-40 sidebar-motion"
          >
            <button onClick={closeSidebar} className="ml-auto mt-5 block">
              <XMarkIcon className="size-8 text-black" />
            </button>
            <nav className="space-y-3 mt-5 pb-10 border-b-2 border-gray-200">
              {[
                "Home",
                "Shop",
                "Collections",
                ...
                >
                  ...
                  >
                    <span
                      className="inline-block hover:text-purple-500"
                    >
                      {item}
                    </span>
                  </a>
